...
class VisitorPage extends StatefulWidget {
  final String userId;
  const VisitorPage({Key? key, required this.userId}) : super(key: key);
...
class _VisitorPageState extends State<VisitorPage> {
  ...
  getData(keyword, limit, offset) async {
    try {
      var url = Uri.parse(ApiService.reportVisitor);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: !isProcess
            ? VisitorList(userType: userType, data: listData)
