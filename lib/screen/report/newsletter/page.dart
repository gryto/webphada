...
class NewsletterPage extends StatefulWidget {
  final String userId;
  const NewsletterPage({Key? key, required this.userId}) : super(key: key);
...
class _NewsletterPageState extends State<NewsletterPage> {
  ...
  getData(keyword, limit, offset) async {
    try {
      var url = Uri.parse(ApiService.reportNewsletter);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: !isProcess
            ? NewsletterList(userType: userType, data: listData)
